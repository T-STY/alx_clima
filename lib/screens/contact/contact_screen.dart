        ...
        child: Column(
          children: [
            ...
            _ContactCard(
              icon: Iconsax.call,
              title: 'Llamar',
              subtitle: AppConstants.technicianPhone,
            ...
            _ContactCard(
              ...
              onTap: () async {
                final uri = Uri.parse(
                    'https://wa.me/${AppConstants.technicianWhatsApp}');
                if (await canLaunchUrl(uri)) {
            ...
            _ContactCard(
              ...
              subtitle: AppConstants.technicianEmail,
              color: AppTheme.secondaryColor,
              onTap: () async {
                final uri =
                    Uri.parse('mailto:${AppConstants.technicianEmail}');
                if (await canLaunchUrl(uri)) {
                  await launchUrl(uri);
                }
              },
                  ...
                  Container(
                    ...
                    child: Row(
                      children: [
                        ...
                        Expanded(
                          child: Text(
                            'Para emergencias fuera de horario, llama directamente',
